...
# Настройка весов для сетки, чтобы дерево растягивалось
...
"""Проверяет уникальность E-mail среди всех контактов. Игнорирует текущий редактируемый контакт."""
...
# Обновление данных в списке контактов
...
"""Обновляет данные в виджете Treeview."""
...
"""Обработчик выбора контакта в списке."""
selected_items = self.tree.selection()
if not selected_items:
return

# Получаем индекс выбранного контакта в списке self.contacts
